...
$(function() {
	...
	$(document).ready(function() {
		var columns = [{
			...
			options = {
				url : contextPath + '/mFSAction/getAllPrays.action',
				idField : 'FS_ID',
		...
		//创建easyUI datagrid
		$("#datagridFSPray").datagrid(options);
		$("#aj-basicSearch").click(function() {//搜索
			$("#datagridFSPray").datagrid("load",$.serializeObject($('#aj-searchFormnode')));
		});
		
		$("#microbasic-searchReset-btn").click(function() {
			$("#datagridFSPray").datagrid("load",{ });
		});
