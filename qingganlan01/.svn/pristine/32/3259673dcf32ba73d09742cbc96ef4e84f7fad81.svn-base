...
public class Blog {
    ...
    public Integer getUpvoteNo() {
        return upvoteNo;
    }

    public void setUpvoteNo(Integer upvoteNo) {
    ...
    public void setDeleteYn(String deleteYn) {
        this.deleteYn = deleteYn == null ? null : deleteYn.trim();
    }
    ...
    public void setForwarding(String forwarding) {
        this.forwarding = forwarding == null ? null : forwarding.trim();
    }
